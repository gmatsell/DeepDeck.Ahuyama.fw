...
void update_oled(void)
{
	...
	if (battery_percent != prev_battery_percent)
	{
		...
		snprintf(buf, sizeof(uint32_t), "%u", (unsigned)battery_percent);
		u8g2_DrawStr(&u8g2, 103 + offset_x_batt, 7 + offset_y_batt, "%");
		if ((battery_percent < 100) && ((battery_percent >= prev_battery_percent + 2) || (prev_battery_percent >= battery_percent + 2)))
		{
